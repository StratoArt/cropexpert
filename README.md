...
## v0.17.3
- Fix PWA service-worker cache version and precache all 30 crop SVGs.
- Add consistent SVG icons for Formulasi, Scan, Library, Database Pestisida, Calculator.
- Add complete dark-theme overrides for home cards, lists, forms, and navigation surfaces.
- Register service worker with updateViaCache:none and trigger update().


## v0.17.4 — SVG icon sprite
Seluruh icon OPT/crop/UI SVG dikonsolidasikan ke `assets/icons.svg` agar repository lebih sederhana. Data crop tetap menyimpan `icon` sebagai nama symbol SVG.
